...
namespace ExcelDynamicCase
{
    public partial class L2_Battle : ILevel
    {
        ...
        public string LevelName => "Rival Battle";
        ...
        public void RunSetup()
        {
            ...
            this.Cells[4, 2].Value = $"{Player} challenges you to a battle for the {ContestedFunction} function!";

            this.Cells[6, 2].Value = $"Here is the question, you have {NumberOfMinutes} minutes - which you can follow on the 'Information' tab.";
            this.Cells[7, 2].Value = $"Note the answer must be pasted as a value.";
