...
namespace Assets.Creator_Kit___RPG.Logic
{
    public static class BattleManager
    {
        ...
        => questionRewardClassification switch
        {
            ...
            QuestionRewardClassification.BasicMaths => new int[] { 1, 6, 40000 },
            QuestionRewardClassification.ExpertMaths => new int[] { 17, 30398, },
            QuestionRewardClassification.BasicText => new int[] { 2, 11, 40001, },
            QuestionRewardClassification.AdvancedText => new int[] { 12, 40005, },
