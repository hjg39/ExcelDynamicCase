...
namespace Assets.ExcelDomain
{
    public static class QuestionRewardsDatabase
    {
        ...
        public static Dictionary<QuestionRewardClassification, string[]> FunctionRewardsByClassification = new()
        {
            ...
            { QuestionRewardClassification.BasicLookup, new string[] { "HLOOKUP", "ISERROR", "LOOKUP", "ISREF", "FIND", "SEARCH", "ROW", "COLUMN", "ADDRESS", "INFO", "CELL", "INDIRECT", "XMATCH", "SHEET", "ISNUMBER", "MATCH" }  },
            ...
            { QuestionRewardClassification.BasicMaths, new string[] { "ABS", "MOD", "SQRT", "ODD", "EVEN", "INT", "ISODD", "ISEVEN", "FLOOR.MATH", "ROMAN", "ARABIC", "CEILING.MATH", "DELTA", "SIGN", "ATAN", "PI", "SEQUENCE"  }  },
            ...
            { QuestionRewardClassification.BasicText, new string[] { "RIGHT", "CLEAN", "LEFT", "CHAR", "CODE", "UNICHAR", "UNICODE", "REPT", "PROPER", "T", "TRIM", "VALUETOTEXT", "REPLACE", "TEXTAFTER", "ARRAYTOTEXT", "TEXT" }  },
